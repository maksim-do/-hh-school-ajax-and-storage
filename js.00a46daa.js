...
},{}],"node_modules/on-change/lib/constants.js":[function(require,module,exports) {
module.exports = {
  PATH_SEPARATOR: '.',
  ...
  var handler = {
    ...
    apply: function apply(target, thisArg, argumentsList) {
      ...
      if (SmartClone.isHandledType(thisProxyTarget)) {
        ...
        var isHandledMethod = SmartClone.isHandledMethod(thisProxyTarget, target.name);
        ...
        return SmartClone.isHandledType(result) && isHandledMethod ? cache.getProxy(result, applyPath, handler) : result;
      }
...
var _ = _interopRequireDefault(require("../images/404.jpeg"));
...
var _default = function _default() {
  var pathApi = 'https://api.themoviedb.org/3/search/movie';
  var urlPathApi = new URL(pathApi);
  var pathImage = 'http://image.tmdb.org/t/p/w185';
  var imgNotFound = _.default;
  ...
  var dataListFormSearch = document.querySelector('.form-search__data-list');
  var containerResultSearch = document.querySelector('.column-row');
  var resultSearchMovies = document.querySelector('.form-search__result-search-movies');
  var currentSearch = JSON.parse(localStorage.getItem('history')); // Состояние поиска
  ...
  var render = function render() {
    var lastSearch = watchedState.lastSearch;
    var _watchedState$current = watchedState.currentSearch,
        value = _watchedState$current.value,
        films = _watchedState$current.films;
    var visibleListSearch = watchedState.visibleListSearch;
    var latestSentences = lastSearch.map(function (_ref) {
      var value = _ref.value;
      return value;
    });
    var latests = value === '' ? latestSentences : latestSentences.filter(function (el) {
      return el.includes(value);
    });
    var setHints = new Set(latests.concat(films));
    var hints = Array.from(setHints).slice(0, 10).reverse();
    ...
    var renderResultSearchMovies = function renderResultSearchMovies() {
      resultSearchMovies.innerHTML = '';
      hints.map(function (el) {
    ...
    var createSearchResultElements = function createSearchResultElements() {
      containerResultSearch.innerHTML = '';

      var f = function f(resultSearch) {
        var value = resultSearch.value,
            films = resultSearch.films;
        var heading = document.createElement('h2');
        heading.classList.add('heading', 'heading_level-2');
        heading.textContent = "Search: ".concat(value);
        ...
        films.forEach(function (film) {
          ...
          var movieCardImageContainer = document.createElement('div');
          movieCardImageContainer.classList.add('movie-card__image-container');
          var movieCardImage = document.createElement('img');
          movieCardImage.classList.add('movie-card__image');
          var imgSrc = poster_path === null ? imgNotFound : "".concat(pathImage).concat(poster_path);
          movieCardImage.src = imgSrc;
          var movieCardTitle = document.createElement('div');
          movieCardTitle.classList.add('movie-card__title');
          movieCardTitle.textContent = original_title;
          var movieCardYear = document.createElement('div');
          movieCardYear.classList.add('movie-card__year');
          var year = new Date(release_date).getFullYear();
          movieCardYear.textContent = Number.isNaN(year) ? '' : "(".concat(year, ")");
    ...
    var showListSearsh = function showListSearsh() {
  ...
  var watchedState = (0, _onChange.default)(state, function () {
    render();
  });
  watchedState.lastSearch = currentSearch === null ? [] : currentSearch;

  var getTitleList = /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              films = _context.sent;
              return _context.abrupt("return", films.results.map(function (_ref3) {
                var original_title = _ref3.original_title;
    ...
    return function getTitleList(_x) {
      return _ref2.apply(this, arguments);
    };
  }();

  var getListFilms = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              return _context2.abrupt("return", films.results.map(function (_ref5) {
                var original_title = _ref5.original_title,
                    poster_path = _ref5.poster_path,
                    release_date = _ref5.release_date;
                return {
    ...
    return function getListFilms(_x2) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.next = 8;
              return getTitleList(query);

            case 8:
              titles = _context3.sent;
              films = titles.filter(function (el) {
                return !state.lastSearch.includes(el);
              }).slice(0, 10);
              watchedState.currentSearch = {
                value: value,
                films: films
  ...
  searchForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var formData, value, query, films, setLastSearch, lastSearch;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              setLastSearch = [{
                value: value,
                films: films
              }].concat(_toConsumableArray(watchedState.lastSearch.filter(function (el) {
                return el.value !== value;
              })));
              lastSearch = setLastSearch.slice(0, 5);
...
},{"on-change":"node_modules/on-change/index.js","../images/404.jpeg":"images/404.jpeg"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
(0, _application.default)();
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./application":"js/application.js"}],"../.nvm/versions/node/v12.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../.nvm/versions/node/v12.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
